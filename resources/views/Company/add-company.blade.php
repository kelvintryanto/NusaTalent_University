...
<head>
	...
	<title> Career Center - Add Company </title>
	
	<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
	
	{!!$data['css']!!}

	<link href="{{ url('assets/css/company-profile.css') }}" rel="stylesheet" type="text/css">
</head>
								...
								<div class="row" style="margin-top: 1%">
									<div class="form-group">
										...
										<div class="col-lg-4">
											...
											<button type="submit" class="btn btn-primary" id="btnGeneratePassword" style="position: absolute;top: 34px;right: 10px;"> <i class=" icon-rotate-ccw3"> </i> </button>
										</div>
									</div>
								</div>
