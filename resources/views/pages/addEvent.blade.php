...
<div class="page-header">
    ...
    <div class="page-container">
        ...
        <div class="panel-card" style="flex-direction: column;">
            <form method="get" action="/event/addEventData">
                {{ csrf_field() }}
                <div style="display: flex;">
                    ...
                    <div class="col-lg-6 col-sm-5 col-md-6" style="margin-right: 5%; margin-top: 50px;">
                        <input type="text" class="form-control text2 form-bottom" id="eventName" placeholder="Event Name" name="eventName">
                    </div>
                ...
                <div style="display: flex; margin-top: 30px;">
                    ...
                    <div class="flex-content" style="width: 50%; margin-left: 30px;">
                        <div style="width: 95%;">
                            <textarea class="text2 textareaAC" style="overflow:auto;height: 100px !important; width: 100%; padding: 8px;" onkeyup="textAreaAdjust(this)" placeholder="Description of this Event..." name="eventShortDesc" id="eventShortDesc"></textarea>
                        </div>
                        <div class="flex-content" style="width: 50%; margin-top: 5px;">
                            <label class="text16">Start Date</label>
                            <input type="date" class="form-control text2 form-bottom" id="startDate" name="startDate">
                        </div>
                        <div class="flex-content" style="width: 50%; margin-top: 5px;">
                            <label class="text16">End Date</label>
                            <input type="date" class="form-control text2 form-bottom" id="endDate" name="endDate">
                        </div>
                        <div class="flex-content" style="width: 50%; margin-top: 5px;">
                            <label class="text16">Capacity</label>
                            <input type="number" class="form-control text2 form-bottom" id="capacity" name="capacity" placeholder="kapasitas peserta perusahaan">
                        </div>
                        <div class="flex-content" style="width: 50%; margin-top: 5px;">
