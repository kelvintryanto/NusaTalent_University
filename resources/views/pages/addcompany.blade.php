...
<div class="page-header">
	...
	<div class="page-container">
		...
		<div class="panel-university" style="flex-direction: column;">
			...
			<div style="display: flex; margin-top: 30px;">
				...
				<div class="flex-content" style="width: 100%; margin-left: 30px;">
					<div style="width: 95%;">
						<textarea class="text2 textareaAC" style="overflow:auto;height: 40px !important;" onkeyup="textAreaAdjust(this)" placeholder="Profile"></textarea>
					</div>
					<div class="flex-content" style="margin-top: 20px;">
						<label class="text16">Website</label>
						<input type="text" class="form-control text2 form-bottom" id="website" placeholder="Website" name="website" style="width: 50%;">
					</div>
					<div class="flex-content" style="margin-top: 20px;">
					...
					<div class="flex-content" style="margin-top: 20px;">
						...
						<select type="text" class="form-control text2 form-bottom" id="industry" placeholder="Industry" name="industry" style="width: 25%;">
							<option class="text2">coba</option>
						</select>
					</div>
					<div class="flex-content" style="margin-top: 20px;">
						<label class="text16">LinkedIn</label>
						<input type="text17" class="form-control text2 form-bottom" id="linkedin" placeholder="LinkedIn" name="linkedin" style="width: 50%;">
					</div>
			...
			<div style="display: flex; margin-top: 20px;">
				...
				<div class="flex-content" style="width: 100%; margin-left: 20px;">
					<form>
						<div>
	                    	<label class="text16">Headquarter Address Name</label>
